...
// import { setCoinId } from "../../../state/actions";
...
const CoinsTable = () => {
  ...
  return (
    <div className=" bg-black  bg-bannerBg py-5 text-center">
      <div className="container mx-auto">
        ...
        <table className=" mx-auto w-full  lg:w-3/4">
          <thead>
            <tr className=" rounded-s-xl bg-orange-600">
          ...
          {handleSearch().map((row) => {
            ...
            return (
              <tbody>
                <tr className=" border-b-2 hover:bg-gray-800" key={row.name}>
